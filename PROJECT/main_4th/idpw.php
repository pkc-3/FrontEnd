...
<!-- ======================================================================================================== -->
    ...
    <div class="container">
        ...
        <tr>
          <th colspan="2">
            <h3 class="id_title">아이디 찾기&nbsp;/&nbsp;패스워드 변경</h3>
          </th>
        </tr>
        <tr>
          <td colspan="2" align="center">
            <input type="button" value="아이디찾기" class="btn btn-primary" onclick="location.href='idpw_id.php'">
            <input type="button" value="비밀번호변경" class="btn btn-primary" onclick="location.href='idpw_pw.php'">
          </td>
        </tr>
          </table>
