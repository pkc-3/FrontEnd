...
<!-- ======================================================================================================== -->
  ...
  <table class="table table-bordered">
    ...
    <?
      ...
      $startRow=($page-1)*10;
      $sql="select * from notice where $search like '%$searchString%' order by no desc limit $startRow, 10";
    ...
    <tr>
      ...
      <td><? if(isset($_SESSION["id"])){
              ?>
              <a href="notice_search_content.php?no=<?=$row["no"]?>&searchString=<?=$searchString?>&search=<?=$search?>">
              <?=$row["title"]?></a>
              <? }
            else{?>
              <?=$row["title"]?>
      ...
      <td colspan="5" align="center">
        <form name="frm1" method="post" action="notice_search.php">
          ...
          if(isset($searchString)){?>
            <input type="button" class="btn btn-primary" value="뒤로가기" onclick="location.href='notice.php'">
          <? }
          else{?>
          ...
          <? if(isset($_SESSION["id"])){
            ...
            <input type="button" class="btn btn-primary" value="새로 작성" onclick="location.href='notice_write.php'">
          <? }} ?>
        </form>
      </td>
    </tr>
...
<!-- ======================================================================================================== -->
    ...
    function back(){
      location.href="notice_search.php?searchString=<?=$searchString?>";
    }
    </script>
  </body>
</html>
