    ...
    <tr>
      <td colspan="2" align="center">
        <? if(isset($_SESSION["id"])){
            ...
            <input type="button" class="btn btn-primary" value="수정하기" onclick="location.href='qna_edit.php?no=<?=$no?>'">
          <? }} ?>
          <input type="hidden" value="<?=$searchString?>">
        <input type="button" value="뒤로가기" onclick="location.href='qna_search.php?no=<?=$no?>&searchString=<?=$searchString?>&search=<?=$search?>'" class="btn btn-primary">
      </td>
    </tr>
  </table>
  </form>
