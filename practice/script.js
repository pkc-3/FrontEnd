...
function curr_slide(e){
	if(e==1){
		$(".imgs>img").eq(now+1).css({"left":-1220+sp});
		$(".imgs>img").eq(now+2).css({"left":-610+sp});
		$(".imgs>img").eq(now+3).css({"left":0+sp});
		$(".imgs>img").eq(now+4).css({"left":610+sp});
		$(".imgs>img").eq(now+5).css({"left":1220+sp});
		...
		$(".imgs>img").eq(now+2).css({"left":-1220+sp});
		$(".imgs>img").eq(now+3).css({"left":-610+sp});
		$(".imgs>img").eq(now+4).css({"left":0+sp});
		$(".imgs>img").eq(now+5).css({"left":610+sp});
		$(".imgs>img").eq(now+0).css({"left":1220+sp});
		...
		$(".imgs>img").eq(now+3).css({"left":-1220+sp});
		$(".imgs>img").eq(now+4).css({"left":-610+sp});
		$(".imgs>img").eq(now+5).css({"left":0+sp});
		$(".imgs>img").eq(now+0).css({"left":610+sp});
		$(".imgs>img").eq(now+1).css({"left":1220+sp});
		...
		$(".imgs>img").eq(now+4).css({"left":-1220+sp});
		$(".imgs>img").eq(now+5).css({"left":-610+sp});
		$(".imgs>img").eq(now+0).css({"left":0+sp});
		$(".imgs>img").eq(now+1).css({"left":610+sp});
		$(".imgs>img").eq(now+2).css({"left":1220+sp});
		...
		$(".imgs>img").eq(now+5).css({"left":-1220+sp});
		$(".imgs>img").eq(now+0).css({"left":-610+sp});
		$(".imgs>img").eq(now+1).css({"left":0+sp});
		$(".imgs>img").eq(now+2).css({"left":610+sp});
		$(".imgs>img").eq(now+3).css({"left":1220+sp});
